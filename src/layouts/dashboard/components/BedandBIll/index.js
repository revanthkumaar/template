...
import MDTypography from 'components/MDTypography';function BedandBill(props) {
...
<Grid item xs={12} md={6} lg={3}>
<MDBox mb={1.5}>
<Card sx={{ minWidth: 240, minHeight: 100, background: "#a52a2a" }} style={{backgroundColor: "#a52a2a"}}>
...
<Grid item xs={12} md={6} lg={3}>
<MDBox mb={1.5}>
<Card sx={{ minWidth: 240, minHeight: 100, background: "#2E8B57" }}style={{backgroundColor: "#2E8B57"}}>
<CardContent sx={{ align: "center" }}>
<MDTypography
color="light"
mt={1}
...
<Grid item xs={12} md={6} lg={3}>
<MDBox mb={1.5}>
<Card sx={{ minWidth: 240, minHeight: 100, background: '#00008B' }}style={{backgroundColor: "#00008B"}}>
<CardContent sx={{ align: 'center' }}>
...
<Grid item xs={12} md={6} lg={3}>
<MDBox mb={1.5}>
<Card sx={{ minWidth: 240, minHeight: 100, background: "#800080" }}style={{backgroundColor: "#800080"}}>
<CardContent sx={{ align: "center" }}>
<MDTypography
color="light"
mt={1}
